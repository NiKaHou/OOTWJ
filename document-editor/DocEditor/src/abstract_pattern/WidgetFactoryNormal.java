...
public class WidgetFactoryNormal extends WidgetFactory{
	FileItemProcess fileitemprocess;
	private MenuBar menuBar;

	public WidgetFactoryNormal(Stage stage) {
		super(stage);
...
//		root.add(urdo);
	...
	private MenuBar createMenuBar(MenuBarComponent component) {
		...
		MenuBar menuBar = new NormalMenuBar();
		while (component.hasChild()) {
			...
			while (tmpMenuComponent.hasChild()) {
				...
				MenuItem menuItem = new NormalMenuItem();
